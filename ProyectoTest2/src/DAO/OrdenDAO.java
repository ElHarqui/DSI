...
public class OrdenDAO implements IOrden {
    ...
    public List<Orden> listarOrdenes() {
        ...
        try (Connection conn = ConexionBD.obtenerConexion();
            ...
            while (rs.next()) {
                ...
                orden.setFechaInicio(rs.getDate("fechaInicio"));//Falta
                orden.setFechaTermino(rs.getDate("fechaAcabado"));//falta
                orden.setIdProducto(rs.getInt("idProducto")); // Guardar el nombre del producto
    ...
    public boolean agregarOrden(Orden orden) {
        ...
        try (PreparedStatement stmt = conexion.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS)) {
            stmt.setDate(1, orden.getFechaInicio());
            stmt.setDate(2,orden.getFechaTermino());
    ...
    public boolean editarOrden(Orden orden) {
        ...
        try (PreparedStatement stmt = conexion.prepareStatement(sql)) {
            ...
            stmt.setDate(2, orden.getFechaInicio());
            stmt.setDate(3, orden.getFechaTermino());
